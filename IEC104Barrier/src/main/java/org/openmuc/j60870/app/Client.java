...
public final class Client {
	...
	static JButton bpayday, bfreeday, bquit;
	static JFrame frame;
	static JPanel panel_int;
	static JLabel StatusCars;
	
	//Initialization of Host and Port parameters
    private static final StringCliParameter hostParam = new CliParameterBuilder("-h").buildStringParameter("host", "192.168.43.237");
    ...
    public static void main(String[] args) {
    	...
    	//"Paying Day" Button 
    	JButton bpayday = new JButton("Paying Day");
    	bpayday.addActionListener(new ActionListener(){
			public void actionPerformed(java.awt.event.ActionEvent e){
				System.out.println("** Sending 'Paying Day' command. ** \n");
            	try {
					connection.setNormalizedValueCommand(commonAddrParam.getValue(), 
							CauseOfTransmission.ACTIVATION, 2, new IeNormalizedValue(2), 
    	...
    	//"Free Day" Button 
    	JButton bfreeday= new JButton("Free Day");
    	bfreeday.addActionListener(new ActionListener(){
			public void actionPerformed(java.awt.event.ActionEvent e){
				System.out.println("** Sending 'Free Day' command. ** \n");
            	try {
					connection.setNormalizedValueCommand(commonAddrParam.getValue(), 
    	...
    	panel_int.add(bpayday);
    	panel_int.add(bfreeday);
    	panel_int.add(bquit);
